...
(defgroup gb-henna-theme nil
  "Options for the `gb-henna' theme."
  :group 'doom-themes)

(defcustom gb-henna-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'gb-henna-theme
  :type 'boolean)

(defcustom gb-henna-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'gb-henna-theme
  :type 'boolean)

(defcustom gb-henna-comment-bg gb-henna-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'gb-henna-theme
  :type 'boolean)

(defcustom gb-henna-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme gb-henna
  ...
  ((bg         '("#21272e" nil       nil            ))
   ...
   (-modeline-bright gb-henna-brighter-modeline)
   (-modeline-pad
    (when gb-henna-padded-modeline
      (if (integerp gb-henna-padded-modeline) gb-henna-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :background (if gb-henna-comment-bg (doom-lighten bg 0.05) 'unspecified))
   ...
   (org-document-info-keyword     :foreground base8)
   (org-done              :foreground base8)
