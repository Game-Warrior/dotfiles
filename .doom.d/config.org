#+TITLE: Gardner's Doom Emacs Config
#+AUTHOR: Gardner Berry
#+DESCRIPTION: GW's personal Doom Emacs config.
...
* SET FONT SIZE
Set default font scaling. I have added this for my laptop that has a hiDPi display.
#+begin_src emacs-lisp
