...
#+BEGIN_EXAMPLE
yay -S brave-bin librewolf-bin starship exa pfetch pokemon-colorscripts-git lxapperance emacs nemo alcritty alacritty-themes lxapperance nitrogen fish neovim ripgrep fd
#+END_EXAMPLE
** .bashrc
