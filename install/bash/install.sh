...
sudo pacman -S awesome dmenu picom starship arandr exa btop lxappearance emacs alacritty zsh nitrogen fish neovim ripgrep fd chromium speedtest-cli hunspell-en_us
...
paru -S brave-bin librewolf-bin pfetch pokemon-colorscripts-git alacritty-themes mint-themes mint-y-icons hyfetch
